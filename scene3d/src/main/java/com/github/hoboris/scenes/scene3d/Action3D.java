package com.github.hoboris.scenes.scene3d;
...
/** Actions attach to an {@link Actor3D} and perform some task, often over time.
 * @author Nathan Sweet */
abstract public class Action3D<T extends Action3D> implements Poolable {
        /** The actor this action is attached to, or null if it is not attached. */
        protected Actor3D actor;

        private Pool<Action3D<T>> pool;
